            ...
            <div className="project_card">
              ...
              <div className="summary">
                ...
                <p>
                  ...
                  analyse les forces et faiblesses des personnages composant
                  votre équipe au fur et à mesure de la phase de sélection de
                  personnages et conseille les personnages adaptés aux besoins
                  de votre composition actuelle.
                </p>
                <p>
            ...
            <div className="project_card_thae">
              <div className="summary">
                ...
                <p>
                  ...
                  morceaux pour le label Lofi Girl, je lui ai proposé de faire
                  un site Web pour sa musique, ce qu'il a accepté.
                </p>
                <p>
